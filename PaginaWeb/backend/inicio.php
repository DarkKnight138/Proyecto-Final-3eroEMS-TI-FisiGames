...
<body>
 ...
 <script>
   const menuToggle = document.getElementById('menu-toggle'); // Obtiene el botón o icono del menú
   const navbar = document.getElementById('navbar'); // Obtiene la barra de navegación

   // Agrega un evento que detecta cuando se hace clic en el botón del menú
   menuToggle.addEventListener('click', () => {
     navbar.classList.toggle('expanded'); // Alterna la clase 'expanded' para mostrar u ocultar el menú
   });
</script>
